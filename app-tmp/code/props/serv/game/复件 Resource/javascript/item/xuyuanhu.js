...
function OnUse(jssystem, self, user,type)
{
    ...
    switch(index)
    {
		...
		case 167:
        {
            PutItem(jssystem,self,user,"i180026",count);
            break;
        }
		case 168:
        {
            PutItem(jssystem,self,user,"i180021",count);
            break;
        }
		case 176:
        {
            PutItem(jssystem,self,user,"i491045",count);
            break;
        }
		case 177:
        {
            PutItem(jssystem,self,user,"i491046",count);
            break;
        }
		case 178:
        {
            PutItem(jssystem,self,user,"i491047",count);
            break;
        }
		case 179:
        {
            PutItem(jssystem,self,user,"i491048",count);
            break;
        }
		case 180:
        {
            PutItem(jssystem,self,user,"i491049",count);
            break;
        }
		case 181:
        {
            PutItem(jssystem,self,user,"i491050",count);
            break;
        }
		case 182:
        {
            PutItem(jssystem,self,user,"i491051",count);
            break;
        }
		case 183:
        {
            PutItem(jssystem,self,user,"i491052",count);
            break;
        }
		case 184:
        {
            PutItem(jssystem,self,user,"i290067",count);
            break;
        }	
		case 185:
        {
            PutItem(jssystem,self,user,"i290031",count);
            break;
        }
		case 186:
        {
            PutItem(jssystem,self,user,"i2927670",count);
            break;
        }
		case 187:
        {
            PutItem(jssystem,self,user,"i2927310",count);
            break;
        }
		case 188:
        {
            PutItem(jssystem,self,user,"i290053",count);
            break;
        }	
		case 189:
        {
            PutItem(jssystem,self,user,"i290044",count);
            break;
        }
		case 190:
        {
            PutItem(jssystem,self,user,"i2927530",count);
            break;
        }
		case 191:
        {
            PutItem(jssystem,self,user,"i2927440",count);
            break;
        }
	        default:
        {
