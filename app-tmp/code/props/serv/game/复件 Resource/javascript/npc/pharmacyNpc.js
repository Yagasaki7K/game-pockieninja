...
function OnSelect(jssystem, self, send, type)
{
    ...
    var npcShopSystem = jssystem.GetNpcShopSystem();
    ...
    if (type == 1)
    {
        ...
        var v = new VarList();
        kernel.AddTitle(self, "NpcMenuTitle_Build_Pharmacy", null);
        kernel.AddMenu(self, "NpcMenu_Pharmacy_Enter", 10, null);
    ...
    {
        kernel.CloseMenu(send);
        npcShopSystem.OpenNpcShop(self, send);
    }
}
