...
GenFile = {
	...
	[7] = {
		...
		step = {
			...
			[25] = {excel = "Item/Item.xlsx" , 		sheet = "SustainItem"},
			[26] = {excel = "Item/Item.xlsx" , 		sheet = "blooditem"},
			[27] = {excel = "Item/Item.xlsx" , 		sheet = "bloodsoul"},
		}
	},
	[8] = {
...
--	},
	...
	[210] = {
		name = "cardConstants.ini" , subdir = "cardhome" , type = 0,
		step = {
    ...
    [229] = {
		name = "SighInScore.ini" , subdir = "active" , type = 3,
		step = {
			[1] = {excel = "Active/MonthSighIn.xlsx" , sheet = "SighInScore"},
		}
	},
	[230] = {
		name = "NormalGiftOdd.ini" , subdir = "active" , type = 0,
		step = {
			[1] = {excel = "Active/MonthSighIn.xlsx" , sheet = "NormalGiftOdd"},
		}
	},
	[231] = {
		name = "SpecialGiftOdd.ini" , subdir = "active" , type = 0,
		step = {
			[1] = {excel = "Active/MonthSighIn.xlsx" , sheet = "SpecialGiftOdd"},
		}
	},
	[232] = {
		name = "SighInCfg.ini" , subdir = "active" , type = 3,
		step = {
			[1] = {excel = "Active/MonthSighIn.xlsx" , sheet = "SighInCfg"},
		}
	},
	[233] = { name = "NinjaNpc.ini" , subdir = "npc" , type = 0,
		step = {
			[1] = {excel = "Npc/Npc.xlsx" , sheet = "NinjaNpc"},
		}
	},
	[234] = { name = "bloodsoulGather.ini" , subdir = "item" , type = 0,
		step = {
			[1] = {excel = "Item/Item.xlsx" , sheet = "bloodsoulGather"},
		}
	},
	[235] = { name = "bloodsoulLib.ini" , subdir = "item" , type = 0,
		step = {
			[1] = {excel = "Item/Item.xlsx" , sheet = "bloodsoulLib"},
		}
	},
	[236] = { name = "bloodsoulPropDefine.ini" , subdir = "item" , type = 0,
		step = {
			[1] = {excel = "Item/Item.xlsx" , sheet = "bloodsoulPropDefine"},
		}
	},
};
